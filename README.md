...
*   **Hero Section:** Pantalla completa con fondo inmersivo y botones con efecto "Glassmorphism".
*   **Carrusel de Modos de Juego:** Slider personalizado para mostrar los modos Creativo, Supervivencia y Multijugador, con flechas de navegación SVG personalizadas y tipografía moderna (`Segoe UI`) para mejor legibilidad.
*   **Sección de Noticias:** Grid de tarjetas con efecto *hover* que despliega suavemente la descripción de la noticia.
*   **Sección de Trailers:** Video de YouTube embebido en un contenedor responsivo.
...
Proyecto_PW1/
├── assets/
│   ├── images/          # Imágenes y texturas del sitio
│   └── styles/
│       └── index-styles.css  # Hoja de estilos principal
...
---
Desarrollado por el equipo de Proyecto PW1 - 2025